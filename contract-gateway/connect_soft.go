...
const (
	...
	cryptoPath    = "/home/wz/go/src/github.com/hyperledger/FabricLearn/6_ContractGatewayAndSDK/orgs/soft.ifantasy.net"	// 中间变量
...
// 创建指向联盟链网络的 gRPC 连接.
func newGrpcConnectionSoft() *grpc.ClientConn {
...
func newIdentitySoft() *identity.X509Identity {
...
// 使用私钥从消息摘要生成数字签名
func newSignSoft() identity.Sign {
